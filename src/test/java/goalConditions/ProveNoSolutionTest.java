...
public class ProveNoSolutionTest {
    ...
    public void TestInvalidRules() throws InvalidFileFormatException {
        Assert.assertFalse(
                TestUtilities.verifyBoard("goalConditions/ProveNoSolution/InvalidLine", puzzle));
        ...
        Assert.assertFalse(
                TestUtilities.verifyBoard("goalConditions/ProveNoSolution/InvalidCases", puzzle));
    }
    ...
    public void TestRootNode() throws InvalidFileFormatException {
        Assert.assertFalse(
                TestUtilities.verifyBoard("goalConditions/ProveNoSolution/RootIncomplete", puzzle));
    }
    ...
    public void TestSinglePath() throws InvalidFileFormatException {
        ...
        Assert.assertFalse(
                TestUtilities.verifyBoard("goalConditions/ProveNoSolution/CompleteLine", puzzle));

        Assert.assertFalse(
                TestUtilities.verifyBoard("goalConditions/ProveNoSolution/IncompleteLine", puzzle));
    }
