...
public class ProveValuesAreImpossible {
    ...
    public void TestSinglePath() throws InvalidFileFormatException {
        ...
        Assert.assertTrue(
                TestUtilities.verifyBoard(
                        "goalConditions/ProveValuesAreImpossible/IncompleteLineWithoutMatch",
                        puzzle));
    ...
    public void TestComplexPaths() throws InvalidFileFormatException {
        ...
        Assert.assertTrue(
                TestUtilities.verifyBoard(
                        "goalConditions/ProveValuesAreImpossible/MultipleSolutionsOneMatchEach",
                        puzzle));

        Assert.assertFalse(
                TestUtilities.verifyBoard(
                        "goalConditions/ProveValuesAreImpossible/SingleSolutionWithMatchAndUnfinished",
                        puzzle));

        Assert.assertFalse(
                TestUtilities.verifyBoard(
                        "goalConditions/ProveValuesAreImpossible/MultipleSolutionsOneCorrect",
                        puzzle));

        Assert.assertFalse(
                TestUtilities.verifyBoard(
                        "goalConditions/ProveValuesAreImpossible/SingleSolutionAndUnfinishedWithMatch",
                        puzzle));
    }
}
