...
public class ProveValuesArePossible{
    ...
    public void TestSinglePath() throws InvalidFileFormatException {
        ...
        Assert.assertFalse(TestUtilities.verifyBoard(
                "goalConditions/ProveValuesArePossible/IncompleteLineWithoutMatch", puzzle));
    }
    ...
    public void TestComplexPaths() throws InvalidFileFormatException {
        ...
        Assert.assertTrue(TestUtilities.verifyBoard(
                "goalConditions/ProveValuesArePossible/MultipleSolutionsOneCorrect", puzzle));

        Assert.assertTrue(TestUtilities.verifyBoard(
                "goalConditions/ProveValuesArePossible/SingleSolutionWithMatchAndUnfinished", puzzle));

        Assert.assertFalse(TestUtilities.verifyBoard(
                "goalConditions/ProveValuesArePossible/MultipleSolutionsOneMatchEach", puzzle));

        Assert.assertFalse(TestUtilities.verifyBoard(
                "goalConditions/ProveValuesArePossible/SingleSolutionAndUnfinishedWithMatch", puzzle));
