...
public class ConditionalEliminationTest {
   ...
   *
   * <p>Asserts that the only valid combination of A and B that is a valid application of this rule
   * is when A is true and B is false
   *
  ...
  public void FalseConditionalTest() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/shorttruthtable/rules/ConditionalEliminationDirectRule/FalseConditional", stt);
  ...
  public void CannotSetBothAandBTrueConditionalTest() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/shorttruthtable/rules/ConditionalEliminationDirectRule/TrueConditional", stt);
    TreeNode rootNode = stt.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
