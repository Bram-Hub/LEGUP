...
public class AndIntroductionDirectRuleTest {
   ...
   *
   * <p>Asserts that if at least 1 of A or B is false, then this is a valid application of the rule
   ...
   * Given a statement: A ^ B
   *
   * <p>Asserts that setting ^ to true is a valid application of the rule if and only if both A and
   * B are true.
   *
   * @param filePath The file path for test board setup.
   * @throws InvalidFileFormatException
