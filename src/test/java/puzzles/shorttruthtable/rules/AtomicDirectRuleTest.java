...
public class AtomicDirectRuleTest {
   ...
   * Given two statements: A A where the first A is set to false.
   *
   * <p>This test sets the second A to true and then asserts that this is not a valid application of
   * the rule.
   *
   * @throws InvalidFileFormatException
   */
   ...
   *
   * <p>This test sets the second B to true and then asserts that this is a valid application of the
   * rule.
   *
   * @throws InvalidFileFormatException
   */
   ...
   * Given two statements: C C where neither statement is set to anything.
   *
   * <p>This test sets the second C to true and then asserts that this is not a valid application of
   * the rule.
   *
   * @throws InvalidFileFormatException
   */
