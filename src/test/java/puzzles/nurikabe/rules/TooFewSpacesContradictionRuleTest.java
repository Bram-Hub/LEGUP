...
public class TooFewSpacesContradictionRuleTest {
  ...
  public void TooFewSpacesContradictionRule_TwoSurroundBlackTest()
    ...
    TestUtilities.importTestBoard(
        "puzzles/nurikabe/rules/TooFewSpacesContradictionRule/TwoSurroundBlack", nurikabe);
  ...
  public void TooFewSpacesContradictionRule_FalseTooFewSpaces() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/nurikabe/rules/TooFewSpacesContradictionRule/FalseTooFewSpaces", nurikabe);
    TreeNode rootNode = nurikabe.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
