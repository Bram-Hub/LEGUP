...
public class FillinBlackDirectRuleTest {
    ...
    /**
     * Tests the Fillin Black direct rule for a square surrounded by black in the middle of the
     * board
     */
    @Test
    public void FillinBlackDirectRule_UnknownSurroundBlackTest() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinBlackDirectRule/UnknownSurroundBlack", nurikabe);
    ...
    /**
     * Tests the Fillin Black direct rule for a square surrounded by black in the top left corner of
     * the board
     */
    @Test
    public void FillinBlackDirectRule_CornerTest1() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinBlackDirectRule/CornerBlack1", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    /**
     * Tests the Fillin Black direct rule for a square surrounded by black in the bottom right
     * corner of the board
     */
    @Test
    public void FillinBlackDirectRule_CornerTest2() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinBlackDirectRule/CornerBlack2", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    public void FillinBlackDirectRule_FalseTest() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinBlackDirectRule/FalseFillinBlack", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
