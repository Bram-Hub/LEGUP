...
public class BlackSquareContradictionRuleTest {
    ...
    public void BlackSquareContradictionRule_TwoSurroundBlackTest()
        ...
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/BlackSquareContradictionRule/SimpleBlackSquare", nurikabe);
    ...
    public void BlackSquareContradictionRule_CornerSquareTest() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/BlackSquareContradictionRule/CornerBlackSquare", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    public void BlackSquareContradictionRule_FalseBlackSquareTest()
            throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/BlackSquareContradictionRule/FalseBlackSquare", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
