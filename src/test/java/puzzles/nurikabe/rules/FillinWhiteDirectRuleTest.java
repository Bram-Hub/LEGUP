...
public class FillinWhiteDirectRuleTest {
    ...
    /**
     * Tests the Fillin White direct rule for a square surrounded by white in the middle of the
     * board
     */
    @Test
    public void FillinWhiteDirectRule_UnknownSurroundWhiteTest() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinWhiteDirectRule/UnknownSurroundWhite", nurikabe);
    ...
    /**
     * Tests the Fillin White direct rule for a square surrounded by white in the top left corner of
     * the board
     */
    @Test
    public void FillinWhiteDirectRule_CornerTest1() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinWhiteDirectRule/CornerWhite1", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    /**
     * Tests the Fillin White direct rule for a square surrounded by white in the bottom right
     * corner of the board
     */
    @Test
    public void FillinWhiteDirectRule_CornerTest2() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinWhiteDirectRule/CornerWhite2", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    public void FillinWhiteDirectRule_FalseTest() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/FillinWhiteDirectRule/FalseFillinWhite", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
