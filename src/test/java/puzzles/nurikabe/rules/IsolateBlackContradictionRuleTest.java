...
public class IsolateBlackContradictionRuleTest {
  ...
  /**
   * Tests the Isolate Black contradiction rule for a black square in the corner, separated by a
   * diagonal of white squares
   */
  @Test
  public void IsolateBlackContradictionRule_SimpleIsolateBlackTest()
      throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/nurikabe/rules/IsolateBlackContradictionRule/SimpleIsolateBlack", nurikabe);
  ...
  public void IsolateBlackContradictionRule_DiagonalBlackTest() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/nurikabe/rules/IsolateBlackContradictionRule/DiagonalIsolateBlack", nurikabe);
    TreeNode rootNode = nurikabe.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
  ...
  public void IsolateBlackContradictionRule_FalseIsolateBlackTest()
      throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/nurikabe/rules/IsolateBlackContradictionRule/FalseIsolateBlack", nurikabe);
    TreeNode rootNode = nurikabe.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
