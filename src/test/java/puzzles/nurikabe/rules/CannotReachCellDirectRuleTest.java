...
public class CannotReachCellDirectRuleTest {
    ...
    public void CannotReachCellDirectRule_SimpleUnreachableCell()
        ...
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/CannotReachCellDirectRule/SimpleUnreachableCell", nurikabe);
    ...
    public void CannotReachCellDirectRule_AllCellsReachable() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/nurikabe/rules/CannotReachCellDirectRule/AllCellsReachable", nurikabe);
        TreeNode rootNode = nurikabe.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
