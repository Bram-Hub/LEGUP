...
public class TooFewTentsContradictionRuleTest {
  ...
  /**
   * @throws InvalidFileFormatException Using a 1x1 Puzzle Grid, which is just grass, checks if the
   *     fact it expects a tent on the y-axis is caught.
   */
  @Test
  ...
  /**
   * @throws InvalidFileFormatException Using a 1x1 Puzzle Grid, which is just a tent, checks if the
   *     fact it expects 2 tents on the y-axis is caught. (This is an impossible situation given the
   *     constraints, but for the purposes of the test it is fine)
   */
  @Test
  public void TooFewTentsContradictionRule_WithTent() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/treetent/rules/TooFewTentsContradictionRule/TooFewTentsWithTent", treetent);
    TreeNode rootNode = treetent.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
  ...
  /**
   * @throws InvalidFileFormatException Using a 1x1 Puzzle Grid, which is just grass, checks if the
   *     fact it expects a tent on both x and y is caught.
   */
  @Test
  public void TooFewTentsContradictionRule_DoubleBad() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/treetent/rules/TooFewTentsContradictionRule/TooFewTentsDoubleBad", treetent);
    TreeNode rootNode = treetent.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
  ...
  /**
   * @throws InvalidFileFormatException Looks at a 2x2 Board in the format: [] Tr [] Gr Column 2 is
  ...
  public void TooFewTentsContradictionRule_2x2ColumnOnly() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/treetent/rules/TooFewTentsContradictionRule/TooFewTents2x2Column", treetent);
    TreeNode rootNode = treetent.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
  ...
  /**
   * @throws InvalidFileFormatException Looks at a 3x3 Board in the format: [] Tr [] [] Gr [] [] Gr
   *     [] Column 2 is checked to have 1 Tent (which is not present, thus producing a
   *     contradiction)
   */
  @Test
  public void TooFewTentsContradictionRule_3x3OneColumn() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/treetent/rules/TooFewTentsContradictionRule/TooFewTents3x3Column", treetent);
    TreeNode rootNode = treetent.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
  ...
  /**
   * @throws InvalidFileFormatException Looks at a 3x3 Board in the format: Gr Tr Gr Gr [] Gr Gr Tr
   *     Gr Column 1 and 3 are checked to have 1 Tent (which is not present, thus producing a
   *     contradiction)
   */
  @Test
  public void TooFewTentsContradictionRule_3x3TwoColumn() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/treetent/rules/TooFewTentsContradictionRule/TooFewTents3x3DoubleColumn", treetent);
    TreeNode rootNode = treetent.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
  ...
  /**
   * @throws InvalidFileFormatException Looks at a 2x2 Board in the format: Tn [] Tr [] This should
   *     fail the contradiction as it is a legal board.
   */
  @Test
  public void TooFewTentsContradictionRule_NoContradiction() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/treetent/rules/TooFewTentsContradictionRule/TooFewTentsNoContradiction", treetent);
    TreeNode rootNode = treetent.getTree().getRootNode();
    TreeTransition transition = rootNode.getChildren().get(0);
    transition.setRule(RULE);
