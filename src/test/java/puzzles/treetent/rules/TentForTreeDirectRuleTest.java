...
public class TentForTreeDirectRuleTest {
     ...
     * 3x3 TreeTent puzzle Tests TentForTreeDirectRule
     *
     * <p>TREE at (1, 0) and (1, 2); TENT at (1, 1); LINE between (1, 0) and (1, 1) XRX XTX XRX
     *
     * <p>Makes a line between (1, 1) and (1, 2) Checks that the rule fails for the tree at (1, 2)
     * because there are no valid tents to connect to
     */
    @Test
     ...
     * 3x3 TreeTent puzzle Tests TentForTreeDirectRule
     *
     * <p>TREE at (1, 1); TENT at (1, 0) and (1, 2) XTX XRX XTX
     *
     * <p>Makes a line between (1, 1) and (1, 2) Checks that the rule fails for the tree at (1, 1)
     * because there are two valid tents to connect to
     */
    @Test
    public void TentForTreeOneTreeTwoAdjacentTent() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/treetent/rules/TentForTreeDirectRule/OneTreeTwoAdjacentTent", treetent);
