...
public class LastCampingSpotDirectRuleTest {
   ...
   *     <p>Checks if a test works for an empty square above a tree which is surrounded on all other
   *     sides.
   */
  @Test
  ...
  /**
   * @throws InvalidFileFormatException
   *     <p>Checks if a test works for an empty square below a tree which is surrounded on all other
   *     sides.
   */
  @Test
  ...
  /**
   * @throws InvalidFileFormatException
   *     <p>Checks if a test works for an empty square to the left of a tree which is surrounded on
   *     all other sides.
   */
  @Test
  ...
  /**
   * @throws InvalidFileFormatException
   *     <p>Checks if a test works for an empty square to the right of a tree which is surrounded on
   *     all other sides.
   */
  @Test
