...
public class TooManyStarsContradictionRuleTests {
    ...
    @Test
    public void TooManyStarsContradictionRule_RegionOverloaded() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooManyStarsContradictionRule/RegionOverloaded",
                starBattle);
    ...
    more stars than the puzzle number */
    @Test
    public void TooManyStarsContradictionRule_ColumnOverloaded() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooManyStarsContradictionRule/ColumnOverloaded",
                starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    more stars than the puzzle number */
    @Test
    public void TooManyStarsContradictionRule_RowOverloaded() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooManyStarsContradictionRule/RowOverloaded", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    public void TooManyStarsContradictionRule_FalseContradiction()
        ...
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooManyStarsContradictionRule/Correct", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
