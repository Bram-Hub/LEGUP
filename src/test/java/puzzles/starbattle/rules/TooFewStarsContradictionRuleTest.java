...
public class TooFewStarsContradictionRuleTest {
    ...
    @Test
    public void TooFewStarsContradictionRule_Column() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooFewStarsContradictionRule/Column", starBattle);
    ...
    @Test
    public void TooFewStarsContradictionRule_Row() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooFewStarsContradictionRule/Row", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    @Test
    public void TooFewStarsContradictionRule_Region() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooFewStarsContradictionRule/Region", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    public void TooFewStarsContradictionRule_FalseContradiction()
        ...
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooFewStarsContradictionRule/FalseContradiction",
                starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    @Test
    public void TooFewStarsContradictionRule_NotEnoughSpace() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooFewStarsContradictionRule/NotEnoughSpace", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    @Test
    public void TooFewStarsContradictionRule_TwoStarColumn() throws InvalidFileFormatException {

        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooFewStarsContradictionRule/TwoStarColumn", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    public void TooFewStarsContradictionRule_TwoStarFalseContradiction()
            throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/TooFewStarsContradictionRule/TwoStarFalseContradiction",
                starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
