...
public class FinishWithStarsDirectRuleTest {
    ...
    @Test
    public void FinishWithStarsDirectRuleTestCornerRow() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/FinishWithStarsDirectRule/CornerRow", starBattle);
    ...
    @Test
    public void FinishWithStarsDirectRuleTestCornerColumn() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/FinishWithStarsDirectRule/CornerColumn", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    /* Finish With Stars Direct Rule where star is in the corner and only the column is blacked out */
    @Test
    public void FinishWithStarsDirectRuleTestCornerRowColumn() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/FinishWithStarsDirectRule/CornerRowColumn", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    /* Finish With Stars Direct Rule where star is in the corner and only the column is blacked out */
    @Test
    public void FinishWithStarsDirectRuleTestRegion() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/FinishWithStarsDirectRule/Region", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    @Test
    public void FinishWithStarsDirectRuleTestDoubleRegion() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/FinishWithStarsDirectRule/DoubleRegion", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    /* Finish With Stars Direct Rule where there are two stars in two different mostly blacked out regions */
    @Test
    public void FinishWithStarsDirectRuleTestFalse() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/FinishWithStarsDirectRule/False", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
