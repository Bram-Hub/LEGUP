...
public class ColumnsWithinRowsDirectRuleTest {
    ...
    @Test
    public void ColumnsWithinRowsDirectRule_OneColumn() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/ColumnsWithinRowsDirectRule/OneColumn", starbattle);
    ...
    @Test
    public void ColumnsWithinRowsDirectRule_TwoColumns() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/ColumnsWithinRowsDirectRule/TwoColumns", starbattle);
        TreeNode rootNode = starbattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    @Test
    public void ColumnsWithinRowsDirectRule_NonAdjacentColumns() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/ColumnsWithinRowsDirectRule/NonAdjacentColumns",
                starbattle);
        TreeNode rootNode = starbattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    public void ColumnsWithinRowsDirectRule_TwoColumnsStarOverlap()
        ...
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/ColumnsWithinRowsDirectRule/TwoColumnsStarOverlap",
                starbattle);
        TreeNode rootNode = starbattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    @Test
    public void ColumnsWithinRowsDirectRule_PartialCover() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/ColumnsWithinRowsDirectRule/OneColumn", starbattle);
        TreeNode rootNode = starbattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
    ...
    public void ColumnsWithinRowsDirectRule_FalseColumnsWithinRows3()
            throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/ColumnsWithinRowsDirectRule/FalseStarOverlap",
                starbattle);
        TreeNode rootNode = starbattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
