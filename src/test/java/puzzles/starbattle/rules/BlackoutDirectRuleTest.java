...
public class BlackoutDirectRuleTest {
    ...
    @Test
    public void BlackoutDirectRuleTestCorner() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/BlackoutDirectRule/Corner", starBattle);
    ...
    @Test
    public void BlackoutDirectRuleTestEdge() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/BlackoutDirectRule/Edge", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    /* Blackout Direct Rule where star is on the edge */
    @Test
    public void BlackoutDirectRuleTestMiddle() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/BlackoutDirectRule/Middle", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
    ...
    @Test
    public void BlackoutDirectRuleTestFalse() throws InvalidFileFormatException {
        TestUtilities.importTestBoard(
                "puzzles/starbattle/rules/BlackoutDirectRule/Middle", starBattle);
        TreeNode rootNode = starBattle.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
