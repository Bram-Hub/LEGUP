...
public class EmptyCellinLightDirectRuleTest {
  ...
  @Test
  // tests a 3x3 board with with a 0 black tile in the center and lightbulbs in top left and bototm
  // right
  ...
  public void EmptyCellinLightDirectRule() throws InvalidFileFormatException {
    ...
    // because it is a black tile, and (1,3),(3,1),(3,3) because they are not lit. Confirm the rest
    // are empty
    LightUpCell c;
