...
public class LightOrEmptyCaseRuleTest {
  ...
  // creates boards for what is expected output, and checks that the getcases function produces the
  // correct boards
  ...
  public void LightOrEmptyTest() throws InvalidFileFormatException {
    TestUtilities.importTestBoard(
        "puzzles/lightup/rules/LightOrEmptyCaseRule/LightOrEmpty", lightUp);
