...
import edu.rpi.legup.puzzle.minesweeper.rules.MustNotContainBombDirectRule;
...
public class MustNotContainBombDirectRuleTest {

    public static final MustNotContainBombDirectRule RULE = new MustNotContainBombDirectRule();
