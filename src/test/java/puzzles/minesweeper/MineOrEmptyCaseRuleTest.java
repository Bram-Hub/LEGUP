...
public class MineOrEmptyCaseRuleTest {
     ...
     * modified cell that is either mine or empty. <br><br>This is what MineOrEmpty.txt looks like:
     * <pre>
     *  _| _| _|
     *  _| _| _|
     *  _| _| _|</pre>
     *  <br>
     *  This test gets the cases for the top right corner cell and checks that there are two of them, that
     *  they are different, and that none of the other cells are different between the two cases.
     */
    @Test
