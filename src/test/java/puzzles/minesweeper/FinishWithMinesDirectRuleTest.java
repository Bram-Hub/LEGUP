...
public class FinishWithMinesDirectRuleTest {
    ...
    /**
     * Checks that FinishWithMinesDirectRule behaves as expected in simple scenario. <br>
     * <br>
    ...
    /**
     * Check that FinisWithMinesDirectRUle behaves as expected in scenario where it is used one of
     * many viable cells. <br>
     * <br>
     ...
     *
     * <br>
     * This test explicitly changes the center cell in the left-hoof column from UNSET to MINE. That
     * cell should be accepted by the rule, although this rule could be used, and validate, with the
     * three other UNSET cells, the rule must only be used on a cell the user has interacted with.
     */
    @Test
    ...
    /**
     * Check that FinisWithMinesDirectRUle behaves as expected in scenario where it is used with
     * multiple cells. <br>
     * <br>
     * This is what 3x3test3.txt looks like:
     *
     ...
     *
     * <br>
     * This test explicitly changes the center cell in the left most column from UNSET to MINE. As
     * well as the bottom left one, the top right one, and the center one in the top row. Those
     * changes should represent a complete use of this rule, the '4' cell no has four mines in its
     * bubble. Because of that, all those cells should be accepted by the rule.
     */
    @Test
    ...
    /**
     * Check that FinishWithMinesDirectRule behaves as expected in 'full bubble' scenario. <br>
     * <br>
     ...
     *
     * <br>
     * This test explicitly changes all the UNSET cells (the entire bubble of the '8' cell) to
     * MINEs. That is a complete use of this rule. The '8' cell is satisfied by that number of
     * mines, and all those changed cells should be valid uses of this rule.
     */
    @Test
    ...
    /**
     * Check that FinishWithMinesDirectRule behaves as expected in the 'overlapping bubbles'
     * scenario. <br>
     * <br>
     ...
     *
     * <br>
     * This test explicitly changes the middle cell from UNSET to mine. Now, this should be a valid
     * use of the rule in relation to each of the '1' cells adjacent to it, and it should be a
     * complete use of the rule for each of those as well. It satisfies the number of mines for all
     * the ones. The important thing is that the rule behaves as it should, allowing itself to work
     * in multiple bubbles at one.
     */
    @Test
     ...
     *
     * <br>
     * This test explicitly changes the center cells in the furthest left and right columns from
     * UNSET to MINE. The rule should accept both of these as valid uses and no other cells. This
     * continues the bubble overlap and satisfy-mine-count-for-multiple-number-cells logic.
     */
    @Test
    ...
    /**
     * Check that FinishWithMinesDirectRule behaves as expected in diminished bubble overlap
     * scenario. <br>
     * <br>
     ...
     *
     * <br>
     * This test explicitly changes the middle cell from UNSET to MINE. This is an incomplete use of
     * the rule. However, it is accepted in relation to both or either of the number cells, as it is
     * the only cell which they share.
     */
    @Test
    ...
    /**
     * Check that FinishWithMinesDirectRule continues to behave as expected in diminished bubble
     * overlap scenario. <br>
     * <br>
     * This is what 3x3test7.txt looks like:
     *
     ...
     *
     * <br>
     * This test explicitly changes each UNSET sell to a MINE. This is a complete use of the rule.
     * It allows for some of the cells to belong to one number's 'domain', and one of them to be
     * shared.
     */
    @Test
