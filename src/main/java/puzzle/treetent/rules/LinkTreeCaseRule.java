...
public class LinkTreeCaseRule extends CaseRule
{
    ...
    {
        super("Links from tree", "A tree must link to exactly one adjacent tent.", "images/treetent/caseLinkTree.png");
    }
    ...
    public Board getCaseBoard(Board board)
    {
        ...
        for(ElementData data: caseBoard.getElementData()){
            ...
            if(cell.getType() == TreeTentType.TREE && !cell.isLinked() && branches.size() > 0){
