...
public class CursorController {
   ...
   * ActionListener while also displaying a loading cursor if the time it takes to execute the given
   * process exceeds the time (in milliseconds) specified in this.DELAY
   *
