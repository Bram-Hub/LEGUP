...
public class ValidateContradictionRuleCommand extends PuzzleCommand {
  ...
  public void executeCommand() {
    ...
    for (TreeElementView view : selectedViews) {
      ...
      treeNode
          .getChildren()
          .forEach(n -> puzzle.notifyTreeListeners(listener -> listener.onTreeElementRemoved(n)));
  ...
  public void undoCommand() {
    ...
    for (TreeElementView view : selectedViews) {
      ...
      if (save != null) {
        ...
        node.getChildren()
            .forEach(n -> puzzle.notifyTreeListeners(listener -> listener.onTreeElementAdded(n)));
      }
    }
