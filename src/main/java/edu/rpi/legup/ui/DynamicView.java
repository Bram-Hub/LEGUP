...
public class DynamicView extends JPanel {
   ...
   *
   * @param type The DynamicView that we are setting up the zoomer for (so the zoomer for the board
   *     view or the zoomer for the proof tree view)
          ...
          new JButton(
              new ImageIcon(
                  ImageIO.read(
                      Objects.requireNonNull(
                          ClassLoader.getSystemClassLoader()
                              .getResource("edu/rpi/legup/imgs/remove.png")))));
