...
public abstract class RulePanel extends JPanel {
   ...
   *     function will compare each rule of puzzle with ruleName, to find exact same, similar rules,
   *     or all the rules with same start letter (if input is a signal letter)
   */
  public void searchForRule(Puzzle puzzle, String ruleName) {
    ...
    if (ruleButtons[0] == null) {
      JOptionPane.showMessageDialog(
          null, "Please input the correct rule name", "Confirm", JOptionPane.INFORMATION_MESSAGE);
    }
  }
   ...
   *     calculate a similarity degree(from 0 to 1). closer to 0 means less similar, and closer to 1
   *     means more similar.
   */
        ...
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent event) {
            ...
            if (!inputRule.isEmpty()) {
              ...
              JOptionPane.showMessageDialog(
                  null, "Please give a name", "Confirm", JOptionPane.INFORMATION_MESSAGE);
            }
          }
        };
