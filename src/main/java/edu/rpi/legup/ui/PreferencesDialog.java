...
public class PreferencesDialog extends JDialog {
  ...
  static {
    try {
      folderIcon =
          ImageIO.read(PreferencesDialog.class.getResource("/edu/rpi/legup/imgs/folder.png"));
    } catch (IOException e) {
  ...
  private JScrollPane createGeneralTab() {
    ...
    fullScreen =
        new JCheckBox(
            "Full Screen", Boolean.valueOf(prefs.getUserPref(LegupPreferences.START_FULL_SCREEN)));
    ...
    darkMode =
        new JCheckBox("Dark Mode", Boolean.valueOf(prefs.getUserPref(LegupPreferences.DARK_MODE)));
    ...
    showMistakes =
        new JCheckBox(
            "Show Mistakes", Boolean.valueOf(prefs.getUserPref(LegupPreferences.SHOW_MISTAKES)));
