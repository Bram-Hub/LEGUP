...
public class MaterialImages {
    ...
    public static final BufferedImage PAINTED_CHECKED_BOX =
            loadImg("/edu/rpi/legup/imgs/painted_checked_box.png");
    public static final BufferedImage OUTLINED_CHECKED_BOX =
            loadImg("/edu/rpi/legup/imgs/outlined_checked_box.png");
    public static final BufferedImage UNCHECKED_BOX =
            loadImg("/edu/rpi/legup/imgs/unchecked_box.png");
    public static final BufferedImage RADIO_BUTTON_ON =
            loadImg("/edu/rpi/legup/imgs/radio_button_on.png");
    public static final BufferedImage RADIO_BUTTON_OFF =
            loadImg("/edu/rpi/legup/imgs/radio_button_off.png");
    public static final BufferedImage TOGGLE_BUTTON_ON =
            loadImg("/edu/rpi/legup/imgs/toggle_on.png");
    public static final BufferedImage TOGGLE_BUTTON_OFF =
            loadImg("/edu/rpi/legup/imgs/toggle_off.png");
    ...
    public static final BufferedImage FLOPPY_DRIVE =
            loadImg("/edu/rpi/legup/imgs/floppy_drive.png");
