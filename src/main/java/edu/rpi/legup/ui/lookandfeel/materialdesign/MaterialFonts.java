...
public class MaterialFonts {
  ...
  public static final Font LIGHT_ITALIC =
      loadFont("/edu/rpi/legup/fonts/Roboto/Roboto-LightItalic.ttf");
  ...
  public static final Font MEDIUM_ITALIC =
      loadFont("/edu/rpi/legup/fonts/Roboto/Roboto-MediumItalic.ttf");
  ...
  public static final Font THIN_ITALIC =
      loadFont("/edu/rpi/legup/fonts/Roboto/Roboto-ThinItalic.ttf");
  ...
  public static Font getRegularFont(float size) {
    ...
    try (InputStream inputStream =
        MaterialFonts.class.getResourceAsStream("/edu/rpi/legup/fonts/Roboto/Roboto-Regular.ttf")) {
