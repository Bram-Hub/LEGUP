...
public class Tree {
  ...
  /**
   * Determines if the tree is valid by checking whether this tree puzzleElement and all descendants
   * of this tree puzzleElement is justified and justified correctly
   *
   ...
   * function. This lowest common ancestor is the most immediate ancestor node such that the list of
   * tree nodes specified are descendants of the node. This will return null if no such ancestor
   * exists
   *
