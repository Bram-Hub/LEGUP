...
public abstract class TreeElement {
  ...
  /**
   * Determines if this tree node leads to a contradiction. Every path from this tree node must lead
   * to a contradiction including all of its children
   *
   ...
   * whether this tree puzzleElement and all descendants of this tree puzzleElement is justified and
   * justified correctly
   *
   ...
   *
   * @return NODE if this tree puzzleElement is a tree node, TRANSITION, if this tree puzzleElement
   *     is a transition
   */
