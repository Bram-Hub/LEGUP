...
public class LegupPreferences {
    ...
    static {
        ...
        defaultPreferencesMap.put(NIGHT_MODE, Boolean.toString(false));
    ...
    static {
        ...
        preferencesMap.put(NIGHT_MODE, preferences.get(NIGHT_MODE, defaultPreferencesMap.get(NIGHT_MODE)));
