...
public class ShortTruthTableStatement extends PuzzleElement<String> {
    ...
    /**
     * Returns an array of three elements where [0] is the left statement type, [1] is this
     * statement type, and [2] is the right statement type. null means either the statement doesn't
