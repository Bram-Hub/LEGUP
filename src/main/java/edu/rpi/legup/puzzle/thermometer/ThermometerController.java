...
public class ThermometerController extends ElementController {
    ...
    /**
     * Updates the state of a ThermometerCell based on user mouse interaction. Left click cycles
     * forward through fill states, right click cycles backward, middle click outputs debug
     * information, and Ctrl + left click opens the selection menu.
     *
