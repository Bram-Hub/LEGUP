...
public class TreeTentView extends GridBoardView {
  ...
  static {
    try {
      TREE =
          ImageIO.read(
              ClassLoader.getSystemResourceAsStream("edu/rpi/legup/images/treetent/tree.png"));
      GRASS =
          ImageIO.read(
              ClassLoader.getSystemResourceAsStream("edu/rpi/legup/images/treetent/grass.png"));
      TENT =
          ImageIO.read(
              ClassLoader.getSystemResourceAsStream("edu/rpi/legup/images/treetent/tent.png"));
    } catch (IOException e) {
  ...
  public TreeTentView(TreeTentBoard board) {
    ...
    for (int i = 0; i < gridSize.height; i++) {
      ...
      clue.setLocation(
          new Point((gridSize.width + 1) * elementSize.width, (i + 1) * elementSize.height));
    ...
    for (int i = 0; i < gridSize.width; i++) {
      ...
      clue.setLocation(
          new Point((i + 1) * elementSize.width, (gridSize.height + 1) * elementSize.height));
      clue.setSize(elementSize);
  ...
  public ElementView getElement(Point point) {
    Point scaledPoint =
        new Point((int) Math.round(point.x / getScale()), (int) Math.round(point.y / getScale()));
