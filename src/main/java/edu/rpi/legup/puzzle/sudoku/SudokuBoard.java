...
public class SudokuBoard extends GridBoard {
  ...
  /**
   * Gets the SudokuCell in the specified group index at the x and y location given The group index
   * must be by less than the width (or height) of the board and the x and y location is relative to
   * the group. This means the x and y values must be less the square root of the width (or height)
   * of the board.
   *
