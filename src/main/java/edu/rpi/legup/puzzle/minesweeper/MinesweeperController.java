...
public class MinesweeperController extends ElementController {
    ...
    /**
     * If the button clicked was button 1, then {@link MinesweeperTileData#fromData(int)}
     * is called with a value of {@code current.data() + 1}.
     * If the button clicked was button 2 or 3, then {@link MinesweeperTileData#fromData(int)}
     * is called with a value of {@code currentData() - 1}
