...
public record MinesweeperTileData(MinesweeperTileType type, int data) {
    ...
    /**
     * Always has a type of {@link MinesweeperTileType#UNSET}, and a data value of
     * {@value UNSET_DATA}
     */
    private static final MinesweeperTileData UNSET = new MinesweeperTileData(MinesweeperTileType.UNSET, UNSET_DATA);
    /**
     * Always has a type of {@link MinesweeperTileType#BOMB}, and a data value of
     * {@value BOMB_DATA}
     */
    private static final MinesweeperTileData BOMB = new MinesweeperTileData(MinesweeperTileType.BOMB, BOMB_DATA);
    /**
     * Always has a type of {@link MinesweeperTileType#EMPTY}, and a data value of
     * {@value EMPTY_DATA}
     */
     ...
     * @return a new {@link MinesweeperTileData} with a {@link MinesweeperTileData#type} of {@link MinesweeperTileType#FLAG}
     * and a {@link MinesweeperTileData#data} of {@code count}
     */
    @Contract(pure = true)
     ...
     * @return If {@code data} is one of {@link MinesweeperTileData#UNSET_DATA},
     * {@link MinesweeperTileData#BOMB_DATA}, or {@link MinesweeperTileData#EMPTY_DATA}, it will return
     * that data. If {@code data} is less than any of the values, or greater than 8, it will return
     * {@link MinesweeperTileData#UNSET_DATA}. Otherwise, it returns {@link MinesweeperTileData#flag(int)}
     * and passes {@code data} as the parameter.
     */
    @Contract(pure = true)
