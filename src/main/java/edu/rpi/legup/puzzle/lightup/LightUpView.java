...
public class LightUpView extends GridBoardView {
  ...
  public DataSelectionView getSelectionPopupMenu() {
    ...
    SelectionItemView item1 =
        new SelectionItemView(element1.getPuzzleElement(), new ImageIcon(element1.getImage()));
    ...
    SelectionItemView item2 =
        new SelectionItemView(element2.getPuzzleElement(), new ImageIcon(element2.getImage()));
    ...
    SelectionItemView item3 =
        new SelectionItemView(element3.getPuzzleElement(), new ImageIcon(element3.getImage()));
