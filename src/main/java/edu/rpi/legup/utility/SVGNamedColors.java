...
/**
 * The {@code SVGNamedColors} class is used to correlate the {@code String} names of colors
 * found in SVG files to their RGB {@code Color} values. These values are found in the
 * <a href="https://www.w3.org/TR/2000/CR-SVG-20001102/types.html#ColorKeywords">
 *     W3C SVG specification.</a>
 */
public class SVGNamedColors {
