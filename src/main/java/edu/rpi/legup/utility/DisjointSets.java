...
public class DisjointSets<T> {
  ...
  /**
   * Creates a unique set that contains the specified puzzleElement. If the specified puzzleElement
   * is null or another set already contains that puzzleElement, this method returns false,
   * indicating that a set was not created
   *
